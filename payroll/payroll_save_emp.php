   ...
   function ApprovePayEmpView($empCode,$pfrom,$pto,$ppay,$badgeno)
    {
            ...
            $query_pay = $connL->prepare('EXEC hrissys_test.dbo.payroll_summary_emp :period_from,:period_to,:location, :emp_code,:badgeno');
   ...
   function ApprovePayEmpView30($empCode,$pfrom,$pto,$pfrom30,$pto30,$ppay,$badgeno)
    {
            ...
            $query_pay = $connL->prepare('EXEC hrissys_test.dbo.payroll_summary_30th_emp :period_from, :period_to , :period_from30, :period_to30 , :location,:emp_code,:badgeno');
            $query_pay->bindValue(':period_from',$pfrom);
            $query_pay->bindValue(':period_to',$pto);
