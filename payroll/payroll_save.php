   ...
   function ApprovePayView($empCode,$pfrom,$pto,$ppay)
    {
            ...
            $query_pay = $connL->prepare('EXEC test_hris.dbo.payroll_summary :period_from, :period_to , :location, :emp_code');
   ...
   function ApprovePayView30($empCode,$pfrom,$pto,$pfrom30,$pto30,$ppay)
    {
            ...
            $query_pay = $connL->prepare('EXEC test_hris.dbo.payroll_summary_30th :period_from, :period_to , :period_from30, :period_to30 , :location, :emp_code');
            $query_pay->bindValue(':period_from',$pfrom);
            $query_pay->bindValue(':period_to',$pto);
