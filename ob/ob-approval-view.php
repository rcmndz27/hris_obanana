...
<link rel="stylesheet" type="text/css" href="../ob/obapp.css">
<script type='text/javascript' src='../ob/ob-approval.js'></script>
...
<div class="container">
    ...
    <div class="main-body mbt">
          ...
          <nav aria-label="breadcrumb" class="main-breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item active font-weight-bold" aria-current="page"><i class='fas fa-building fa-fw'></i>Official Business Approval</li>
            </ol>
          </nav>
    ...
    <div class="row">
        <div class="col-md-12 pt-3">
            <?php $obApproval->GetOBSummary($empCode);?>
        </div>
    </div>

    <div class="row">
        <div class="col-md-12 pt-3" id="obDetails">
