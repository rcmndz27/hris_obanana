<?php
    ...
    Class AttRepDTR{
        ...
        public function GetLateList($dateStart,$dateEnd){
            ...
            $query = 'EXEC test_hris.dbo.xp_attendance_portal_late :startDate,:endDate';
            $param = array(":startDate" => $dateStart, ":endDate" => $dateEnd);
            $stmt =$connL->prepare($query);
            $stmt->execute($param);
            $result = $stmt->fetch();            
        ...
        public function GetUTList($dateStart,$dateEnd){
            ...
            $query = 'EXEC test_hris.dbo.xp_attendance_portal_ut :startDate,:endDate';
            $param = array(":startDate" => $dateStart, ":endDate" => $dateEnd);
            $stmt =$connL->prepare($query);
            $stmt->execute($param);
            $result = $stmt->fetch();            
        ...
        public function GetNList($dateStart,$dateEnd){
            ...
            $query = 'EXEC test_hris.dbo.xp_attendance_portal_nologs :startDate,:endDate';
            $param = array(":startDate" => $dateStart, ":endDate" => $dateEnd);
            $stmt =$connL->prepare($query);
            $stmt->execute($param);
            $result = $stmt->fetch();            
